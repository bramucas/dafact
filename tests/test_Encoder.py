...
class TestEncoder:
    ...
    def expected_facts_factor_3(self):
        return [
            ...
            Function('feature', [String('f4')], True),
            ...
            Function(
                'value',
                [Number(0), String('f4'), Number(1)], True),
            ...
            Function(
                'value',
                [Number(1), String('f4'), Number(0)], True),
        ]
    ...
    def expected_facts(self):
        return [
            ...
            Function(
                'value',
                [Number(0), String('f1'), Number(1)], True),
            Function(
                'value',
                [Number(0), String('f2'), Number(2)], True),
            Function(
                'value',
                [Number(0), String('f3'), Number(3)], True),
            Function('instance', [Number(1)], True),
            Function(
                'value',
                [Number(1), String('f1'), Number(4)], True),
            Function(
                'value',
                [Number(1), String('f2'), Number(5)], True),
            Function(
                'value',
                [Number(1), String('f3'), Number(6)], True),
        ]
    ...
    def expected_facts_factor_0(self):
        return [
            ...
            Function(
                'value',
                [Number(0), String('f1'), Number(26)], True),
            Function(
                'value',
                [Number(0), String('f2'), Number(30)], True),
            Function(
                'value',
                [Number(0), String('f3'), Number(10)], True),
            Function(
                'value',
                [Number(0), String('f4'), Number(1)], True),
            Function('instance', [Number(1)], True),
            Function(
                'value',
                [Number(1), String('f1'), Number(22)], True),
            Function(
                'value',
                [Number(1), String('f2'), Number(28)], True),
            Function(
                'value',
                [Number(1), String('f3'), Number(10)], True),
            Function(
                'value',
                [Number(1), String('f4'), Number(0)], True),
        ]
    ...
    def test_constructor(self, custom_empty_data, custom_decimal_data,
        ...
        expected_feature_names = [
            f'f{i}' for i in range(1, custom_empty_data.shape[1] + 1)
        ]
